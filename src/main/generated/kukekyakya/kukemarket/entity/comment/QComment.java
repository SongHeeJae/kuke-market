...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 397417161L;
    ...
    public final kukekyakya.kukemarket.entity.post.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new kukekyakya.kukemarket.entity.post.QPost(forProperty("post"), inits.get("post")) : null;
    }
